    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('purchase_price') ? 'is-invalid' : '' }}" type="text" name="purchase_price" id="purchase_price" value="{{ old('purchase_price', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sale_price') ? 'is-invalid' : '' }}" type="text" name="sale_price" id="sale_price" value="{{ old('sale_price', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('source_url') ? 'is-invalid' : '' }}" type="text" name="source_url" id="source_url" value="{{ old('source_url', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sold') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sold" id="sold" value="1" {{ old('sold', 0) == 1 ? 'checked' : '' }}>
