    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('conditions') ? 'is-invalid' : '' }}" name="conditions[]" id="conditions" multiple>
                    @foreach($conditions as $id => $condition)
                        <option value="{{ $id }}" {{ (in_array($id, old('conditions', [])) || $product->conditions->contains($id)) ? 'selected' : '' }}>{{ $condition }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('purchase_price') ? 'is-invalid' : '' }}" type="text" name="purchase_price" id="purchase_price" value="{{ old('purchase_price', $product->purchase_price) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sale_price') ? 'is-invalid' : '' }}" type="text" name="sale_price" id="sale_price" value="{{ old('sale_price', $product->sale_price) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('source_url') ? 'is-invalid' : '' }}" type="text" name="source_url" id="source_url" value="{{ old('source_url', $product->source_url) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sold') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="sold" value="0">
                    <input class="form-check-input" type="checkbox" name="sold" id="sold" value="1" {{ $product->sold || old('sold', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="sold">{{ trans('cruds.product.fields.sold') }}</label>
                </div>
                @if($errors->has('sold'))
                    <div class="invalid-feedback">
                        {{ $errors->first('sold') }}
