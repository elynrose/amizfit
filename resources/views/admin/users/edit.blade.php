    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('zip_code') ? 'is-invalid' : '' }}" name="zip_code_id" id="zip_code_id" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('paid_user') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="paid_user" value="0">
                    <input class="form-check-input" type="checkbox" name="paid_user" id="paid_user" value="1" {{ $user->paid_user || old('paid_user', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="paid_user">{{ trans('cruds.user.fields.paid_user') }}</label>
                </div>
