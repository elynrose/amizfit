...
class ConditionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.conditions.create');
    }
    ...
    public function store(StoreConditionRequest $request)
    {
        ...
        return redirect()->route('frontend.conditions.index');
    }
    ...
    public function edit(Condition $condition)
    {
        ...
        return view('frontend.conditions.edit', compact('condition'));
    }
    ...
    public function show(Condition $condition)
    {
        ...
        return view('frontend.conditions.show', compact('condition'));
    }
