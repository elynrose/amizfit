...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.products.create', compact('categories', 'conditions', 'users'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view('frontend.products.edit', compact('categories', 'conditions', 'product', 'users'));
    }
