...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', '2fa', 'admin']], function () {
    ...
    // Condition
    Route::delete('conditions/destroy', 'ConditionController@massDestroy')->name('conditions.massDestroy');
    Route::post('conditions/parse-csv-import', 'ConditionController@parseCsvImport')->name('conditions.parseCsvImport');
    Route::post('conditions/process-csv-import', 'ConditionController@processCsvImport')->name('conditions.processCsvImport');
